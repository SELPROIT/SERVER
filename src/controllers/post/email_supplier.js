...
const emailSupplier = async (userId) => {
    ...
    const mailOptions = {
        ...
        <p>Queremos informarle que ha sido ascendido a proveedor, estams muy contentos de que haya decidido vender con nosotros, y le deseamos el mayor de los exitos!</p>
        `,
    };
