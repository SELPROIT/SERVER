...
const mercado_pago = async (auction) => {
    ...
    if(!isAuction || !isInvert || !existProduct) throw new Error ("Subasta o producto no existen")
    ...
    if (isAuction) {
        ...
        const payment = await mercadopago.preferences.create({
            ...
            notification_url: "https://a659-190-12-11-34.ngrok-free.app/create/webhook",
        })
