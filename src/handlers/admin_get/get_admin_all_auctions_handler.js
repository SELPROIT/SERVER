...
const { sortAuctions, getAuBySubCategory, getAuByCategory, getAuByType, paginateAu } = require("../../controllers/get/aux_filter_sort_page");
const { productByName } = require("../../controllers/get/search_auction_by_name");


const get_admin_all_auctions_handler = async (req, res) => {
    const { page, pageSize, type, category, subcategory, sort, name } = req.query
    try {
